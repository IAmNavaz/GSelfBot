...
exports.run = (bot, msg) => {
    ...
    msg.editEmbed(
        bot.utils.embed('GSelfBot Stats', '***This message will dissappear in 30 seconds.***', [
            {
            ...
            {
                name: ':busts_in_silhouette: Friends',
                value: `${bot.user.friends.size}`,
            },
            {
...
exports.info = {
    name: 'info',
    usage: 'info',
    description: 'Shows you info about GSelfBot'
};
